...
const Formfield = ( props ) => {
  ...
  return (
    <div
      className={`flex my-1 dark:text-white ${
    ...
    >
      ...
      <input
        ...
        className={`flex my-1 transition-all delay-100 ${
          type === "checkbox"
            ? "ml-2 accent-sky-800"
            : `border-2 border-blue-600 dark:border-blue-400 outline-none px-2 min-w-[250px] required:border-2 required:border-red-400 focus:border focus:border-sky-300 dark:text-black`
        }`}
